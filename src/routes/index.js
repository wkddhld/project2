...
const { isAuthenticatedMiddleware, isAuthenticatedAdminMiddleware, checkPassword} = require('../middlewares');
...
apiRouter.use('/my-page', isAuthenticatedMiddleware, checkPassword, userCrudRouter); // 회원 정보 조회 & 수정 & 삭제 라우터 연결
